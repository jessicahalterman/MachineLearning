...
print('After missing ages filled in')
print(train_df.loc[pd.isnull(train_df['Age'])])
...
print('freq_port: ' + freq_port)

# fill in missing port of embarkation with the most common occurrence
for dataset in combine:
...
train_df.to_csv('/Users/jessicahalterman/Documents/MachineLearning/Assignment1/processed_train_data.csv')
